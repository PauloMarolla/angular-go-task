...
export class TaskListSectionComponent {
  ...
  private updateTaskStatus(taskId: string, taskCurrentStatus: TaskStatus, droppedColumn: string) {
    let taskNextStatus: TaskStatus = taskCurrentStatus;

    switch (droppedColumn) {
      case 'to-do-column':
        taskNextStatus = TasksStatusEnum.TODO;
        break;
      case 'doing-column':
        taskNextStatus = TasksStatusEnum.DOING;
        break;
      case 'done-column':
        taskNextStatus = TasksStatusEnum.DONE;
        break;
    }
